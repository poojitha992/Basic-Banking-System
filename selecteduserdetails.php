...
<body style="background-color: rgb(234, 243,250 );">
    ...
    <form action="" method="post">
        ...
        <div class="sender-info">
            ...
            ?>
            <div class="user-info">
                <h1 class="heading-user" style="font-family: Arial, Helvetica, sans-serif;">Sender Information</h1>
        ...
        <div class="receiver-info">
            ...
            <div class="receiver">
                ...
                <h1 class="trans-heading" style="font-family: Arial, Helvetica, sans-serif;">Transfer To</h1>
            ...
            <div class="amount">
                <h1 class="trans-heading" style="font-family: Arial, Helvetica, sans-serif;">Amount</h1>
                <div class="amountInput-section">
                    <input type="number" name="amount" id="" required>
                </div>
            </div>
            <div class="submit">
                <input class="submit-btn" type="submit" value="Transfer" name="submit" style="font-family: Arial, Helvetica, sans-serif;">
            </div>
        </div>
    </form>
